...
_CONFIG_DEFINITIONS = {
    ...
    'MYSQL_HOSTNAME': (str, 'Mysql', 'localhost'),
    'MYSQL_PORT': (int, 'Mysql', 3306),
    'MYSQL_USERNAME': (str, 'Mysql', 'headphones'),
    'MYSQL_PASSWORD': (str, 'Mysql', 'password'),
    'MYSQL_DATABASE': (str, 'Mysql', 'headphones'),
    ...
    'DB_USE_MYSQL': (bool_int, 'General', 0),
